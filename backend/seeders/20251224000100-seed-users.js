...
module.exports = {
  async up (queryInterface) {
    ...
    const usersToSeed = [
      ...
      { id: 3, firstName: 'Player', lastName: 'One', email: 'player1@demo.com', passwordHash: passwordPlayer, role: 'player', status: 'active', createdAt: now, updatedAt: now, position: 'base', height: 1.85 },
      { id: 4, firstName: 'Player', lastName: 'Two', email: 'player2@demo.com', passwordHash: passwordPlayer, role: 'player', status: 'active', createdAt: now, updatedAt: now, position: 'ala-pivot', height: 1.92 },
