...
module.exports = {
  ...
  vocabularies: {
    ...
    goals: [
      'shooting', 'ball_handling', 'finishing', 'passing', 'defense',
      'pick_and_roll', 'conditioning', 'tactics', 'rebounding', 'post_play',
      'transition', 'fundamentals', 'tiro', 'bote', 'manejo', 'finalizacion',
      'pase', 'defensa', 'bloqueo', 'fisico', 'condicionamiento', 'tactica',
      'rebote', 'poste', 'transicion', 'contraataque'
    ]
  },
  ...
  weights: {
    ...
    tagMatch: 0.30,        // Coincidencia de etiquetas con objetivos
    typeMatch: 0.20,       // Coincidencia de tipo con objetivos
    difficultyFit: 0.15,   // Ajuste a nivel/intensidad del jugador
    sessionPhaseFit: 0.20, // Ajuste al fase de sesión (warmup, technical, etc.)
    typeVariety: 0.10,     // Variedad de tipos en la sesión
  ...
  sessionPhaseTypes: {
    ...
    technical: [
      'TECNICA_BOTE', 'TECNICA_PIES', 'TIRO', 'FINALIZACION_ARO', 
      'TECNICA_POSTE', 'PASE', 'ATAQUE_INDIVIDUAL', 'DEFENSA_FUNDAMENTOS'
    ],
    tactical: [
      'TACTICA_ATAQUE', 'TACTICA_ATAQUE_DEFENSA', 'TACTICA_TRANSICION',
      'DEFENSA_INDIVIDUAL', 'DEFENSA_EQUIPO', 'JUEGO_REDUCIDO', 'REBOTE'
    ],
