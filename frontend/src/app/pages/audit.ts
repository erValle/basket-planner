...
export class AuditPage {
            ...
            this.api
                ...
                .pipe(
                    ...
                    catchError((e: unknown) => {
                        const error =
                            e instanceof Error ? e.message : 'No se pudo cargar el audit log.';
    ...
    confirmDeleteAll(): void {
        this.confirmationService.confirm({
            ...
            message:
                '¿Estás seguro de que quieres eliminar TODOS los registros de auditoría? Esta acción no se puede deshacer.',
