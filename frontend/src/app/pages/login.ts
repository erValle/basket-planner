                ...
                error: (e: unknown) => {
                    ...
                    if (e instanceof Error) {
                        ...
                        if (
                            ...
                            errorMessage =
                                'El servidor no responde. Por favor, inténtalo más tarde.';
                        } else if (
                            ...
                            !msgLower.includes('request failed') &&
                            !msgLower.includes('unknown') &&
                            !msgLower.includes('error desconocido')
                        ) {
