...
export class Monitoring {
        ...
        switchMap(() =>
            this.api.getOverview(this.range).pipe(
                ...
                catchError((e: unknown) => {
                    const error =
                        e instanceof Error ? e.message : 'No se ha podido cargar monitoring.';
        ...
        this.recommenderApi.getStatus().subscribe({
            ...
            error: (e: unknown) => {
                ...
                const msg =
                    e instanceof Error
                        ? e.message
                        : 'No se pudo cargar el estado del recomendador.';
    ...
    techCostSeverity(
        cost: MonitoringOverview['recommender']['techCost'],
    ): 'success' | 'warn' | 'danger' {
