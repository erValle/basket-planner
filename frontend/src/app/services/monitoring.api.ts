...
import {
    MonitoringBackendKpis,
    MonitoringOverview,
    MonitoringRange,
    MonitoringRecommenderKpis,
...
export class MonitoringApiService {
    ...
    getOverview(range: MonitoringRange) {
        return this.api
            .post<MonitoringOverview>('/api/monitoring/overview', this.serializeRange(range))
            .pipe(map((res) => res));
    }

    getBackend(range: MonitoringRange) {
        return this.api
            .post<MonitoringBackendKpis>('/api/monitoring/backend', this.serializeRange(range))
            .pipe(map((res) => res));
    }

    getRecommender(range: MonitoringRange) {
        return this.api
            .post<MonitoringRecommenderKpis>(
                '/api/monitoring/recommender',
