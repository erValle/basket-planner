...
export class PlanningApiService {
    ...
    generate(draft: PlanningDraft) {
        ...
        if (mode === 'group') {
            ...
            const groupData: Record<string, unknown> = {
                ...
                intensity:
                    String(draft.intensity).toLowerCase() === 'alta'
                        ? 'high'
    ...
    exportPdf(id: string, versionId: string) {
        return this.http.get(
            `/api/training-plans/${encodeURIComponent(id)}/versions/${encodeURIComponent(versionId)}/export`,
            {
                params: { format: 'pdf' },
                responseType: 'blob',
            },
    ...
    createVersion(id: string, payload: unknown) {
        return this.api.post<any>(
            `/api/training-plans/${encodeURIComponent(id)}/versions`,
            payload,
        );
    }
