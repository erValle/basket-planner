...
export class ExerciseForm implements OnChanges, OnInit {
    ...
    form = this.fb.nonNullable.group({
        ...
        duracionMinutos: this.fb.nonNullable.control(5, [
            Validators.required,
            Validators.min(1),
            Validators.max(60),
        ]),
        dificultadTactica: this.fb.nonNullable.control(3, [
            Validators.required,
            Validators.min(1),
            Validators.max(5),
        ]),
        dificultadTecnica: this.fb.nonNullable.control(3, [
            Validators.required,
            Validators.min(1),
            Validators.max(5),
        ]),
        dificultadFisica: this.fb.nonNullable.control(3, [
            Validators.required,
            Validators.min(1),
            Validators.max(5),
        ]),
        dificultadMental: this.fb.nonNullable.control(3, [
            Validators.required,
            Validators.min(1),
            Validators.max(5),
        ]),
    ...
    setDifficulty(
        field: 'dificultadTactica' | 'dificultadTecnica' | 'dificultadFisica' | 'dificultadMental',
        value: number,
    ): void {
    ...
    toggleMaterial(name: string): void {
        ...
        if (current.includes(name)) {
            this.form.controls.materialesNecesarios.setValue(
                current.filter((m: string) => m !== name),
            );
        } else {
