...
export const routes: Routes = [
	...
	},
	{
		...
		children: [
			...
			{ path: 'dashboard', canActivate: [roleGuard], data: { roles: ROUTE_PERMISSIONS['/dashboard'] }, loadComponent: () => import('./pages/dashboard').then((m) => m.Dashboard) },
			{ path: 'users/new', loadComponent: () => import('./pages/new-user').then((m) => m.NewUser) },
			{ path: 'planning', canActivate: [roleGuard], data: { roles: ROUTE_PERMISSIONS['/planning'] }, loadComponent: () => import('./pages/planning').then((m) => m.Planning) },
			{ path: 'planning/new', canActivate: [roleGuard], data: { roles: ROUTE_PERMISSIONS['/planning/new'] }, loadComponent: () => import('./pages/new-planification').then((m) => m.NewPlanification) },
			{ path: 'planning/:id', canActivate: [roleGuard], data: { roles: ROUTE_PERMISSIONS['/planning/:id'] }, loadComponent: () => import('./pages/planning-detail').then((m) => m.PlanningDetail) },
			{ path: 'planning/:id/edit', canActivate: [roleGuard], data: { roles: ROUTE_PERMISSIONS['/planning/:id/edit'] }, loadComponent: () => import('./pages/planning-edit').then((m) => m.PlanningEdit) },
			{ path: 'planning/session', loadComponent: () => import('./pages/session-detail').then((m) => m.SessionDetail) },
			{ path: 'players', canActivate: [roleGuard], data: { roles: ROUTE_PERMISSIONS['/players'] }, loadComponent: () => import('./pages/players').then((m) => m.Players) },
			{ path: 'player', canActivate: [roleGuard], data: { roles: ROUTE_PERMISSIONS['/player'] }, loadComponent: () => import('./pages/player-dashboard').then((m) => m.PlayerDashboard) },
			{ path: 'player/planning', canActivate: [roleGuard], data: { roles: ROUTE_PERMISSIONS['/player/planning'] }, loadComponent: () => import('./pages/player-planning').then((m) => m.PlayerPlanningPage) },
			{ path: 'player/no-plannings', canActivate: [roleGuard], data: { roles: ROUTE_PERMISSIONS['/player'] }, loadComponent: () => import('./pages/player-no-plannings').then((m) => m.PlayerNoPlanningsPage) },
			{
				path: 'monitoring',
			...
			{ path: 'forbidden', loadComponent: () => import('./pages/forbidden').then((m) => m.ForbiddenPage) },
		]
	},
	{ path: 'not-found', loadComponent: () => import('./pages/not-found').then((m) => m.NotFoundPage) },
